      ...
      <div class="mx-auto py-16 px-4 sm:px-6 lg:px-8 max-w-3xl">
        ...
        <section class="mt-8 space-y-4">
          ...
          <p>
            ...
            <br /><br />
            &emsp;それから、一段落して、「マイクラのプラグインを作ってみたい」と漠然と思って、Javaを始めましたね。最初は、phpに比べて、書くことが多いなと思いましたが、今では、あれは安全性のために必要なことだったんだと理解しているし、あのときのプラグイン書いたコードをマイクラ内でデバッグするという作業はとても良い経験だと思っています。
            <br />
